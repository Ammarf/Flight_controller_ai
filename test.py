...
def test():
    ...
    while True:
        if imu.IMURead():
          ...
          des_attitude = get()
          des_pitch = rc_map(des_attitude[0],-1,1,-45,45)
          des_roll = rc_map(des_attitude[1],-1,1,-45,45)
          des_yaw = rc_map(des_attitude[2],-1,1,-45,45)
